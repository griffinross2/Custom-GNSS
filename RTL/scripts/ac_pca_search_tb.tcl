    ...
    # add_files -fileset sources_1 [ glob D:/github_repos/RISC-V-Core/RTL/IP/xfft_0/hdl/*.vhd ]
    # add_files -fileset sources_1 [ glob D:/github_repos/RISC-V-Core/RTL/IP/xfft_0/synth/*.vhd ]
    ...
    add_files -fileset sim_1 -norecurse ./waveforms/ac_pca_search_tb.wcfg
    ...
    set_property top ac_pca_search_tb [get_fileset sim_1]
    set_property -name {xsim.simulate.log_all_signals} -value {true} -objects [get_filesets sim_1]
    
    set_property xsim.view { ./waveforms/ac_pca_search_tb.wcfg } [get_filesets sim_1]
