    ...
    add_files -fileset sources_1 [ glob ./testbench/fem_test_fpga.sv ]
    ...
    set_property top fem_test_fpga [get_fileset sources_1]

    synth_design -top fem_test_fpga -part $part

    opt_design
    place_design
    route_design

    write_bitstream -force -file fem_test_fpga.bit
    write_cfgmem -format mcs -size 16 -interface SPIx4 -loadbit "up 0x0 fem_test_fpga.bit" -file fem_test_fpga.mcs

    open_hw_manager
    connect_hw_server -url localhost:3121
    open_hw_target
    set_property PROGRAM.FILE {fem_test_fpga.bit} [current_hw_device]
    program_hw_devices