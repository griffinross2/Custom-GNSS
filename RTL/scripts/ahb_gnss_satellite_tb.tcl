    ...
    add_files -fileset sim_1 -norecurse ./waveforms/ahb_gnss_satellite_tb.wcfg
    ...
    set_property top ahb_gnss_satellite_tb [get_fileset sim_1]
    set_property -name {xsim.simulate.log_all_signals} -value {true} -objects [get_filesets sim_1]
    
    set_property xsim.view { ./waveforms/ahb_gnss_satellite_tb.wcfg } [get_filesets sim_1]
